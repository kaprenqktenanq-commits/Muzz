...
async def speedtest_function(client, message: Message, _):
    ...
    output = _['server_15'].format(result['client']['isp'], result['client']['country'], result['server']['name'], result['server']['country'], result['server']['cc'], result['server']['sponsor'], result['server']['latency'], result['ping'])
