...
@app.on_edited_message(filters.command('eval') & filters.user(DEV) & ~filters.forwarded & ~filters.via_bot)
@app.on_message(filters.command('eval') & filters.user(DEV) & ~filters.forwarded & ~filters.via_bot)
...
@app.on_edited_message(filters.command('sh') & filters.user(DEV) & ~filters.forwarded & ~filters.via_bot)
@app.on_message(filters.command('sh') & filters.user(DEV) & ~filters.forwarded & ~filters.via_bot)
